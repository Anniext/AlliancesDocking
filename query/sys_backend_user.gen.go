...
func newSysBackendUser(db *gorm.DB, opts ...gen.DOOption) sysBackendUser {
	...
	_sysBackendUser.Percentage = field.NewFloat64(tableName, "percentage")
	_sysBackendUser.Quota = field.NewFloat64(tableName, "quota")
...
type sysBackendUser struct {
	...
	Email         field.String
	Avatar        field.String
	UserType      field.Int64 // 1-系统管理员；
	OperatorID    field.Int64
	ParentID      field.Int64  // 上级id
	ParentRoute   field.String // 所有上级路径 /2/5/10
	Percentage    field.Float64
	Quota         field.Float64
	KdxfLoginName field.String // 科大讯飞FIF平台login_name
...
func (s *sysBackendUser) updateTableName(table string) *sysBackendUser {
	...
	s.Percentage = field.NewFloat64(table, "percentage")
	s.Quota = field.NewFloat64(table, "quota")
