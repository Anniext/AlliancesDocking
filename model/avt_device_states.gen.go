...
type AvtDeviceState struct {
	...
	CreateTime *time.Time `gorm:"column:create_time;type:datetime;comment:上课时间" json:"create_time"` // 上课时间
	UpdateTime *time.Time `gorm:"column:update_time;type:datetime;comment:下课时间" json:"update_time"` // 下课时间
	Interval   *int64     `gorm:"column:interval;type:int;comment:时间间隔: 更新时间-创建时间" json:"interval"` // 时间间隔: 更新时间-创建时间
